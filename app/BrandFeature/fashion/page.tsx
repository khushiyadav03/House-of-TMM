...
export default function FashionPage() {
  ...
  return (
    <CategoryLayout
      ...
      description="Discover the latest fashion trends, designer collaborations, and style inspirations."
    >
      {loading ? (
                  ...
                  {articles.map((article) => (
                    ...
                    >
                      <Link href={`/articles/${article.slug}`}>
                        ...
                        <div className="p-4">
                          <h3 className="font-semibold text-lg mb-2 line-clamp-2 hover:text-gray-600">
                            {article.title}
                          </h3>
